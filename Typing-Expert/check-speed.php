...
<body>
    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            <div class="col-md-10 offset-lg-1 m-3 mx-auto lessonwords text-center">
                Test your typing skill with Typing Experts.with our team and increase your skill.</div> 
        </div>
    </div>
    <!-- End Paragraph-->
    <!-- Timer -->
    ...
    <div class="container-fluid py-5 motive" id="keyboard">
        ...
        <div class="row">
            <div class="w-100 mx-auto keyboard">
                ...
                <div class="keyboard-row mb-2 text-center">
                    <button class="key mx-1 py-2 px-4 btn btn-outline-warning" style="width: 12.2%;">shift</button>
                ...
                <div class="keyboard-row mb-2 text-center">
                    ...
                    <button class="key mx-1 py-2 px-3 btn btn-outline-warning" style="width: 50%;">space</button>
