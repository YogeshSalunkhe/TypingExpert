...
<?php include 'header.php' ?>
    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            ...
            PHP has a vast standard library, as well as numerous third-party libraries and frameworks available
             for various purposes such as web development, image processing, data manipulation, and more.
             PHP is a powerful and versatile language for web development, widely used for creating dynamic and interactive websites and web applications.
            </div> 
        </div>
    </div>
    <!-- End Paragraph-->
