...
<?php include 'header.php' ?>
    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            ...
            Java syntax is derived from C and C++, making it relatively easy for developers 
            familiar with those languages to learn Java. Its syntax is clean and straightforward,
             making it accessible for beginners as well. Everything in Java is an object, which allows for modular and reusable code.
            </div> 
        </div>
    </div>
    <!-- End Paragraph-->
