...
<?php include 'header.php' ?>
    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            <div class="col-md-10 offset-lg-1 m-3 mx-auto text-center lessonwords">
            Java comes with a comprehensive standard library (Java API) that provides a wide 
            range of classes and methods for common tasks such as file I/O, networking, data structures, 
            GUI development, and more. This reduces the need for developers to write code from scratch for common functionalities.
            </div>
        </div>
    </div>
    <!-- End Paragraph-->
