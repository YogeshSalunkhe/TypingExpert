...
<?php include 'header.php' ?>
    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            ...
            PHP code is embedded within HTML, allowing developers to mix PHP and HTML seamlessly within the same file. This makes it easy to generate HTML dynamically based on data or conditions.
             PHP has built-in functions for interacting with databases, particularly with MySQL, which is a widely used database management system.
            </div> 
        </div>
    </div>
    <!-- End Paragraph-->
