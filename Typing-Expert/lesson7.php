    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            <div class="col-md-10 offset-lg-1 m-5 mx-auto lessonwords">
                In this lesson we will learn how to type the symbol characters. You have already learned several of them
                in previous lessons, but now we will complete your symbol typing skills. We will begin by revisiting the
                number keys you just learned in the previous lesson, but this time we will have a look at the associated
                 characters with those keys.
            </div>
        </div>
    </div>
    <!-- End Paragraph-->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="timer col-md-10 offset-lg-1 my-1 d-flex justify-content-center">
                ...
                <div id="display" class="badge bg-warning d-flex mx-5"><span id="minute">00</span>: <span
                        id="second">00</span></div>
            </div>
        </div>
    </div>
    <!-- End Timer -->
