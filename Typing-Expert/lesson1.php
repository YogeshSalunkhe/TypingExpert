...
<?php include 'header.php' ?>
    ...
    <div class="container-fluid motive" id="sentence">
        <div class="row pt-3">
            ...
            PHP is executed on the server side, meaning the PHP code is processed on the server before being sent to the client's web browser. 
            This allows dynamic content generation based on user inputs, database interactions, and other server-side operations.PHP is an open-source language.
            </div> 
        </div>
    </div>
    <!-- End Paragraph-->
